...
import ru.radiationx.anilibria.ui.fragments.settings.PlayerSettingsFragment
...
class PlayerSettingsActivity : BaseActivity(R.layout.activity_settings) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.toolbar.title = "Настройки плеера"
        binding.toolbar.setNavigationOnClickListener {
            finish()
        }

        supportFragmentManager.beginTransaction()
            .replace(R.id.fragment_content, PlayerSettingsFragment())
            .commitNow()
    }
    ...
    companion object {
        fun newIntent(context: Context): Intent {
            return Intent(context, PlayerSettingsActivity::class.java)
        }
    }
}
